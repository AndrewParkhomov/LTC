...
internal val EnStrings = Strings(
    ...
    compareListThicknessAxisColumn = "Thk axis",
    compareListThicknessCenterColumn = "Thk cntr",
    compareListThicknessMinColumn = "Thk min",
    compareListThicknessMaxColumn = "Thk max",
