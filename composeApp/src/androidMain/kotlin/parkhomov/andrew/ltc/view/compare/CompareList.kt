...
import parkhomov.andrew.ltc.extencions.dip
import parkhomov.andrew.ltc.extencions.getColorFromId
...
class CompareList : Fragment(R.layout.compare) {
    ...
    private fun setUpAdapter(compareSet: Set<CalculatedDataOld>) {
