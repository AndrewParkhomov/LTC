package parkhomov.andrew.ltc.view.thickness
...
class ThicknessViewModel : ViewModel() {
    ...
    private val _showResult: MutableSharedFlow<CalculatedDataOld> = MutableSharedFlow()
    val showResult: SharedFlow<CalculatedDataOld> = _showResult.asSharedFlow()
    ...
    fun onCalculateBtnClicked(
        ...
        val calculatedDataOld = if (cylinderPower == 0.0) {
            CalculatedDataOld(
        ...
        _showResult.emit(calculatedDataOld)
    }
