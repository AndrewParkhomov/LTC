        ...
        if(oldVersion < 1){
            ...
            insertItem(db, "Cylinder power", "description of cylinder power",
                    ...
                    "Циліндр","Циліндр - оптична сила лінзи, що застосовується для корекції астигматизму." +
                            ...
                            "викривлене зображення предмета. Одні фрагменти забраження фокусуються на сітківці, " +
                            "інші - перед нею, або поза нею. У результаті цього людина бачить картинку, " +
                            "в якій писутні як чіткі, так і розмиті ділянки і лінії.\n" +
                            "Астигматизм може бути двох видів:\n" +
                            "   - рогівковий\n" +
                            "   - кришталиковий\n" +
                            "Також астигматизм може бути як вродженим, так і набутим. " +
                            "Обов'язково вказується положення осі циліндра у градусах" +
            ...
            insertItem(db, "Real base curve", "description of real base curve",
                    "Кривизна передней поверхности","Действительная кривизна передней " +
                            "поверхности(база линзы), измерятеся в диоприях(в этом приложении), или  в" +
                    ...
                    "Кривизна передньої поверхні","Дійсна кривизна передньої поверхні(база лінзи)" +
                            ", вимірюється у діоптріях(у цьому додатку), або в мілліметрах, міряється " +
            ...
            insertItem(db, "Effective diameter", "description of ed",
                    "Эффективный диаметр","Эффективный диаметр окуляра(Effective diameter)" +
                            ...
                            "горизонтальный размер на 2-3 мм.",
                    "Ефективний діаметр ","Ефективний діаметр окуляра(Effective diameter)" +
                            ...
                            "розмір на 2 - 3 мм.",R.drawable.ed_img);
