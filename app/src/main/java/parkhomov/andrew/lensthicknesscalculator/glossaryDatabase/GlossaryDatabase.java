        ...
        if(oldVersion < 1){
            ...
            insertItem(db, "Pupil distance", "",
                    ...
                    "Відстань між зіницями","Відстань між зіницями, міжцентрова відстань(Pupil distance)" +
                            " - відстань між зіницями в мілліметрах.",R.drawable.pd_img);
            insertItem(db, "Transposition", "Ophthalmologists and a few older optometrists " +
                    ...
                    "Транспозиція","Оптометристи можуть ставити значення циліндра як «+» так і «-»." +
                            ...
                            "лінзи теж тільки у циліндрі із знаком «+». Зараз, в основуному, рецепти" +
                            ...
                            "Приклади:\n" +
                            "   sph -7.0 cyl -3.0 axis 22° можно записати як:\n" +
                            "   sph -10.0 cyl +3.0 axis 112°.\n" +
                            "   sph +5.75 cyl -1.25 axis 165° можно записати як:\n" +
