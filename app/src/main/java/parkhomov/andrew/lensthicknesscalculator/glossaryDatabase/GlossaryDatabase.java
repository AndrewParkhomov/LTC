        ...
        if(oldVersion < 1){
            ...
            insertItem(db, "Index of refraction", "In optics, the refractive index or index of " +
                    ...
                    "Показник заломлення","Показник заломлення - це величина, що характеризує " +
                            ...
                            "Чим більше показник заломлення, тим тоншою є лінза.",R.drawable.index_of_refraction_img);
            ...
            insertItem(db, "Cylinder power", "Cylindrical correction corrects astigmatic refractive " +
                    ...
                    "Циліндр","Циліндр - оптична сила лінзи, що застосовується для корекції астигматизму.\n" +
                            ...
                            "від 1° до 180°(він же 0°). Це пов'язано з особливостями заломлення світла, що " +
                            "проходить крізь циліндричну лінзу:\n" +
                            "   — промені, що проходять перпендикулярно осі циліндра переломлюються\n" +
                            "   — промені, що проходять паралельно осі, не змінюють напрямок руху\n" +
                            "Такі властивості дозволяються «виправити» переломлення світла у потрібному" +
                            " меридіані. Значення циліндра бувають мінусовими і плюсовими.",R.drawable.cylinder_img);
            ...
            insertItem(db, "Real base curve", "The base curve (usually determined from the profile " +
                    ...
                    "Кривизна передньої поверхні","Дійсна кривизна передньої поверхні(база лінзи)" +
                            ", вимірюється у діоптріях(у цьому додатку), або в міліметрах, міряється " +
            ...
            insertItem(db, "Edge thickness", "Thickness of the lens in edge, expressed in millimeters.",
                    ...
                    "Товщина лінзи по краю","Для 'плюсових' лінз мінімальна товщина буде по краю, " +
                            ...
                            "або ж високоіндексні матеріали(1.61, 1.67, 1.74), так як вони більш міцні" +
            ...
            insertItem(db, "Diameter", "Diameter of the lens in millimeters. You can calculate lens" +
                    ...
                    "Діаметр лінзи","Діаметр лінзи в міліметрах. Чим більше діаметр - тим більше " +
                            "товщина лінзи. Розрахувати необхідний діаметр можна у меню " +
            ...
            insertItem(db, "Pupil distance", "Pupil Distance is the distance (expressed in millimeters)" +
                    ...
                    "Відстань між зіницями","Відстань між зіницями, міжцентрова відстань(Pupil distance)" +
                            " - відстань між зіницями в міліметрах.",R.drawable.pd_img);
